...
Este projeto é uma cadeira de rodas semelhante a utilizada pelo famoso fisico Stephen Hawking. De código aberto, livre distribuição e gratuito, esta cadeira funciona por meio de movimentos faciais e comando de voz. Pode ser instalado, mesmo por pessoas leigas em informática, em um raspiberry pi 3, notebook ou Computador de mesa, juntamente com alguns componentes eletrônicos comuns e fáceis de encontrar.  
...
http://www.fmrp.usp.br (Graduação de Informática Biomédica).
